...
from utils import carregar_dados, montar_sidebar, saudacao

# --- Configurações da página --- #
st.set_page_config(page_title="Tabela | Análise de Churn", page_icon="📋", layout="wide")
...
metricas = ["Age", "Tenure in Months", "Monthly Charge", "Total Charges", "Satisfaction Score", "Churn Score", "CLTV"]
